      ...
      <Box
        ...
        <Box
          ...
          <Box
            ...
            <Link textDecoration="none" _hover={{ textDecoration: 'none' }}>
              <Image
                borderRadius="lg"
                src={
                  'https://images.unsplash.com/photo-1611094607507-8c8173e5cf33?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fHdvbWFuJTIweW9nYXxlbnwwfDB8MHx8&auto=format&fit=crop&w=500&q=60'
                }
                alt="some good alt text"
                objectFit="contain"
              />
          ...
          <Box zIndex="1" width="100%" position="absolute" height="100%">
            <Box
              bgGradient={useColorModeValue(
                'radial(pink 1px, transparent 1px)',
                'radial(pink 1px, transparent 1px)'
              )}
              backgroundSize="20px 20px"
              opacity="0.4"
